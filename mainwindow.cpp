    ...
    : QMainWindow(parent)
{
    ...
    Q_ASSERT(baseGameCardsInfo[6]->triggerRoll() == 3);
    ...
    Q_ASSERT(baseGameCardsInfo[16]->triggerRoll() == 10);
    ...
    Q_ASSERT(baseGameCardsInfo[18]->triggerRoll() == 12);
    ...
    Q_ASSERT(extensionCardsInfo[10]->triggerRoll() == 9);
    ...
    Q_ASSERT(extensionCardsInfo[11]->triggerRoll() == 13);
    ...
    Q_ASSERT(extensionCardsInfo[12]->triggerRoll() == 14);
    ...
    Q_ASSERT(expansionCardsInfo[1]->triggerRoll() == 4);
    ...
    Q_ASSERT(expansionCardsInfo[4]->triggerRoll() == 6);
    ...
    Q_ASSERT(expansionCardsInfo[7]->triggerRoll() == 10);
    ...
    Q_ASSERT(expansionCardsInfo[13]->triggerRoll() == 13);
    ...
    Q_ASSERT(expansionCardsInfo[14]->triggerRoll() == 14);
