...
template <> constexpr inline auto StartMenu::qt_create_metaobjectdata<qt_meta_tag_ZN9StartMenuE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'onCreateServer'
        QtMocHelpers::SignalData<void(const QString &, quint16, int)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 3 }, { QMetaType::UShort, 4 }, { QMetaType::Int, 5 },
        }}),
        // Signal 'onCreateClient'
        QtMocHelpers::SignalData<void(const QString &, quint16)>(6, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 7 }, { QMetaType::UShort, 4 },
        }}),
...
void StartMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onCreateServer((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<quint16>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[3]))); break;
        case 1: _t->onCreateClient((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<quint16>>(_a[2]))); break;
        case 2: _t->showMainWindow((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (StartMenu::*)(const QString & , quint16 , int )>(_a, &StartMenu::onCreateServer, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (StartMenu::*)(const QString & , quint16 )>(_a, &StartMenu::onCreateClient, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (StartMenu::*)(int )>(_a, &StartMenu::showMainWindow, 2))
            return;
    }
}
...
// SIGNAL 0
void StartMenu::onCreateServer(const QString & _t1, quint16 _t2, int _t3)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1, _t2, _t3);
}

// SIGNAL 1
void StartMenu::onCreateClient(const QString & _t1, quint16 _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1, _t2);
}

// SIGNAL 2
void StartMenu::showMainWindow(int _t1)
{
