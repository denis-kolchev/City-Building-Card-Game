...
void Server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Server::*)(const QJsonObject & )>(_a, &Server::newMessage, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Server::*)(const QString & )>(_a, &Server::logMessage, 1))
            return;
    }
}
...
// SIGNAL 0
void Server::newMessage(const QJsonObject & _t1)
{
