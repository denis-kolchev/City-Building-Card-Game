...
void Bank::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Bank::*)(std::shared_ptr<Card> );
            if (_q_method_type _q_method = &Bank::bankGetsCard; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (Bank::*)(std::shared_ptr<Card> );
            if (_q_method_type _q_method = &Bank::bankLoosesCard; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
